...
def personalized_greeting(name):
    print(f"Hello {name}, my lovely friend! ")

# TODO: Call the 'personalized_greeting' function with your name
personalized_greeting(name = "Moesha")
...
def apply_operation(function, number):
    return function(number) #the function is acting as a variable and a function 
...
results_2 = apply_operation(double, 7)
print(results_2)
...
results_3 = apply_operation(square, 3)
print(results_3)
